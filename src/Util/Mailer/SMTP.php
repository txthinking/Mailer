...
use Tx\Util\Mailer\Exceptions\CodeException;
use Tx\Util\Mailer\Exceptions\CryptoException;
...
class SMTP
{
    ...
    {
        if (!isset(self::$loggerStatic)) {
            self::$loggerStatic = new Logger('utilMailer');
        }
        $this->logger = self::$loggerStatic;
        SMTPException::setLogger($this->logger);
    }
